...
python tests/test_event_collection_agent.py   # 事项收集
python tests/test_information_query_agent.py  # 信息查询
python tests/test_rag_agent.py          # RAG知识库
```
